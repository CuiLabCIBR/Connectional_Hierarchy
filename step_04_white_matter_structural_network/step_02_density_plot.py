...
def density_show(input_file,x_label,y_label,out_path):
    ...
    ax.set_xticks(np.arange(-6, 4.1, 2))
...
if __name__ == '__main__':
    file_path = 'F:/Cui_Lab/Projects/Connectional_Hierarchy/step_04_white_matter_structural_network'
    y_label = 'FC variability'
    
    input_file = file_path + '/hcpd_fc_variability_sc.csv'
    x_label = 'log(Streamline counts)'    
    out_path = file_path + '/density_plot_fc_variability_sc_hcpd.png'   
    density_show(input_file,x_label,y_label,out_path)

    input_file = file_path + '/hcp_fc_variability_sc.csv'
    x_label = 'log(Streamline counts)'    
    out_path = file_path + '/density_plot_fc_variability_sc_hcp.png'   
    density_show(input_file,x_label,y_label,out_path)